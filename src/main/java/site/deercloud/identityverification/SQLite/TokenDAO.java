...
public class TokenDAO {
    public static void createTable() throws SQLException {
        String sql = "CREATE TABLE IF NOT EXISTS token (\n"
                ...
                + ");";
        Statement statement = SqlManager.session.createStatement();
        statement.execute(sql);
    }

    public static void insert(Token token) throws SQLException {
    ...
    public static Boolean isAccessTokenExpired(String accessToken) throws SQLException {
    ...
    public static Boolean isClientTokenExpired(String clientToken) throws SQLException {
    ...
    public static Boolean isTokenBindProfile(String accessToken) throws SQLException {
        String sql = "SELECT * FROM token WHERE access_token = ?";
        PreparedStatement preparedStatement = SqlManager.session.prepareStatement(sql);
        preparedStatement.setString(1, accessToken);
        ResultSet resultSet = preparedStatement.executeQuery();
    ...
    public static Token selectByAccessToken(String accessToken) throws SQLException {
        String sql = "SELECT * FROM token WHERE access_token = ?";
        PreparedStatement preparedStatement = SqlManager.session.prepareStatement(sql);
        preparedStatement.setString(1, accessToken);
        ResultSet resultSet = preparedStatement.executeQuery();
    ...
    public static void deleteByAccessToken(String accessToken) throws SQLException {
    ...
    public static void deleteByProfileUUID(String profileUUID) throws SQLException {
